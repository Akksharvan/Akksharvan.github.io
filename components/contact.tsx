    ...
    return (
        <motion.section id = "contact" ref = { ref } className = "mb-20 sm:mb-28 w-[min(100%,38rem)] text-center" initial = {{ opacity: 0 }} whileInView = {{ opacity: 1 }} transition = {{ duraction: 1 }} viewport = {{ once: true }}>
            ...
            <form className = "mt-10 flex flex-col dark:text-black">
                ...
                <textarea aria-label = "content" required maxLength = { 500 } className = "h-52 my-3 rounded-lg borderBlack p-4 dark:bg-white dark:bg-opacity-80 dark:focus:bg-opacity-100 transition-all dark:outline-none" placeholder = "Your message" />
